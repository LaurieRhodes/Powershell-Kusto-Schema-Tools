...
resource rubrikthreathuntdataclTable 'Microsoft.OperationalInsights/workspaces/tables@2025-02-01' = {
  parent: workspace
  ...
  properties: {
    ...
    schema: {
      name: 'Rubrik_ThreatHunt_Data_CL'
      description: 'Custom table Rubrik_ThreatHunt_Data_CL - imported from JSON schema'
      displayName: 'Rubrik_ThreatHunt_Data_CL'
      columns: [
        {
          name: 'TimeGenerated'
          type: 'dateTime'
...
output tableName string = rubrikthreathuntdataclTable.name
output tableId string = rubrikthreathuntdataclTable.id
output provisioningState string = rubrikthreathuntdataclTable.properties.provisioningState
