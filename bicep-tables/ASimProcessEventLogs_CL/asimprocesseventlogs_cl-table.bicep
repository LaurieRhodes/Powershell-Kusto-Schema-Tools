// Bicep template for Log Analytics custom table: ASimProcessEventLogs_CL
// Generated on 2025-09-13 20:15:19 UTC
// Source: JSON schema export
// Original columns: 121, Deployed columns: 121 (only 'Type' filtered out)
...
resource asimprocesseventlogsclTable 'Microsoft.OperationalInsights/workspaces/tables@2025-02-01' = {
  parent: workspace
  ...
  properties: {
    ...
    schema: {
      name: 'ASimProcessEventLogs_CL'
      description: 'Custom table ASimProcessEventLogs_CL - imported from JSON schema'
      displayName: 'ASimProcessEventLogs_CL'
      columns: [
        {
          name: 'TimeGenerated'
          type: 'dateTime'
...
output tableName string = asimprocesseventlogsclTable.name
output tableId string = asimprocesseventlogsclTable.id
output provisioningState string = asimprocesseventlogsclTable.properties.provisioningState
