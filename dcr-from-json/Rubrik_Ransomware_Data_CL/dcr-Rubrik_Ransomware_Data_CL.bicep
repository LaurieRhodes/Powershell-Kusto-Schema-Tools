...
// Original columns: 20, DCR columns: 18 (Type column filtered out)
...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-Rubrik_Ransomware_Data_CL'
  location: location
  properties: {
    dataCollectionEndpointId: dataCollectionEndpointId
    streamDeclarations: {
      'Custom-Rubrik_Ransomware_Data_CL': {
        columns: [
          {
            name: 'TimeGenerated'
            type: 'string'
      ...
      logAnalytics: [
        {
          ...
          name: 'Sentinel-Rubrik_Ransomware_Data_CL'
        }
      ]
    }
    dataFlows: [
