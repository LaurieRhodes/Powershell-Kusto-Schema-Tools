    ...
    dataFlows: [
      {
        ...
        transformKql: 'source | project TimeGenerated = todatetime(TimeGenerated), _path_s = tostring(_path_s), _system_name_s = tostring(_system_name_s), _write_ts_t = todatetime(_write_ts_t), ts_t = todatetime(ts_t), node_s = tostring(node_s), prof_core_stack_s = tostring(prof_core_stack_s), prof_script_stack_s = tostring(prof_script_stack_s), prof_sched_wait_ns_d = toreal(prof_sched_wait_ns_d)'
