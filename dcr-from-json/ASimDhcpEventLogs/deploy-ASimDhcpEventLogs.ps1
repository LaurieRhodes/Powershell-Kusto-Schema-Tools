# Deploy ASimDhcpEventLogs Data Collection Rule (from JSON export)
param(
...
Write-Host "Deploying ASimDhcpEventLogs Data Collection Rule (from JSON export)..." -ForegroundColor Cyan
