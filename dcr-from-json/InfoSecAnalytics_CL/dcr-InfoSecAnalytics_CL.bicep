...
// Original columns: 53, DCR columns: 49 (Type column always filtered)
...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-InfoSecAnalytics_CL'
  location: location
  properties: {
    dataCollectionEndpointId: dataCollectionEndpointId
    streamDeclarations: {
      'Custom-InfoSecAnalytics_CL': {
        columns: [
          {
            name: 'TimeGenerated'
            type: 'string'
      ...
      logAnalytics: [
        {
          ...
          name: 'Sentinel-InfoSecAnalytics_CL'
        }
      ]
    }
    dataFlows: [
