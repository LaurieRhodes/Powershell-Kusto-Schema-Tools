    ...
    dataFlows: [
      {
        ...
        transformKql: 'source | project TimeGenerated = todatetime(TimeGenerated), TenantId = toguid(TenantId), custom_details_objectType_s = tostring(custom_details_objectType_s), custom_details_objectName_s = tostring(custom_details_objectName_s), custom_details_type_s = tostring(custom_details_type_s), class_s = tostring(class_s), severity_s = tostring(severity_s), source_s = tostring(source_s), summary_s = tostring(summary_s), custom_details_clusterId_g = tostring(custom_details_clusterId_g), custom_details_id_g = tostring(custom_details_id_g), custom_details_objectId_g = tostring(custom_details_objectId_g), RawData = tostring(RawData), Computer = tostring(Computer), ManagementGroupName = tostring(ManagementGroupName), MG = tostring(MG), SourceSystem = tostring(SourceSystem), custom_details_status_s = tostring(custom_details_status_s), _ResourceId = tostring(_ResourceId)'
