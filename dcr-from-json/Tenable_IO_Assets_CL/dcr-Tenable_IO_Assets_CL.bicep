...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-Tenable_IO_Assets_CL'
  location: location
  properties: {
    dataCollectionEndpointId: dataCollectionEndpointId
    streamDeclarations: {
      'Custom-Tenable_IO_Assets_CL': {
        columns: [
          {
            name: 'TimeGenerated'
            type: 'string'
      ...
      logAnalytics: [
        {
          ...
          name: 'Sentinel-Tenable_IO_Assets_CL'
        }
      ]
    }
    dataFlows: [
      {
        streams: ['Custom-Tenable_IO_Assets_CL']
        destinations: ['Sentinel-Tenable_IO_Assets_CL']
        ...
        outputStream: 'Custom-Tenable_IO_Assets_CL'
      }
    ]
  }
}
