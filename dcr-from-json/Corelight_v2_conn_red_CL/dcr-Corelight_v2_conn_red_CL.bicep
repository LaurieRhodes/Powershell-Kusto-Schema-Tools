...
// ============================================================================
// Data Collection Rule for Corelight_v2_conn_red_CL
// ============================================================================
// Generated: 2025-09-13 20:13:33
// Table type: Custom (presumed custom for JSON exports)
// Schema imported from JSON export file
// Original columns: 46, DCR columns: 43 (Type column filtered out)
// Output stream: Custom-Corelight_v2_conn_red_CL
...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-Corelight_v2_conn_red_CL'
  location: location
  properties: {
      ...
      logAnalytics: [
        {
          ...
          name: 'Sentinel-Corelight_v2_conn_red_CL'
        }
      ]
    }
    dataFlows: [
      {
        streams: ['Custom-Corelight_v2_conn_red_CL']
        destinations: ['Sentinel-Corelight_v2_conn_red_CL']
        ...
        outputStream: 'Custom-Corelight_v2_conn_red_CL'
      }
    ]
  }
}
