    ...
    dataFlows: [
      {
        ...
        transformKql: 'source | project TimeGenerated = todatetime(TimeGenerated), ts_t = todatetime(ts_t), node_s = tostring(node_s), filter_s = tostring(filter_s), init_b = tobool(init_b), success_b = tobool(success_b)'
