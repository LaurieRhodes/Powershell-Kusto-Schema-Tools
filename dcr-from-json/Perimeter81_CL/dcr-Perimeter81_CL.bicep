    ...
    dataFlows: [
      {
        ...
        transformKql: 'source | project TimeGenerated = todatetime(TimeGenerated), TenantId = toguid(TenantId), application_endpoint_s = tostring(application_endpoint_s), application_alias_cname_s = tostring(application_alias_cname_s), idpName_s = tostring(idpName_s), network_name_s = tostring(network_name_s), network_dns_s = tostring(network_dns_s), geoPoint_accuracy_radius_d = toreal(geoPoint_accuracy_radius_d), geoPoint_latitude_d = toreal(geoPoint_latitude_d), geoPoint_longitude_d = toreal(geoPoint_longitude_d), geoPoint_metro_code_d = toreal(geoPoint_metro_code_d), geoPoint_time_zone_s = tostring(geoPoint_time_zone_s), addressCountry_s = tostring(addressCountry_s), event_eventName_s = tostring(event_eventName_s), event_tenantId_s = tostring(event_tenantId_s), event_originalTenantId_s = tostring(event_originalTenantId_s), event_releasedFrom_tenantId_s = tostring(event_releasedFrom_tenantId_s), event_releasedBy_email_s = tostring(event_releasedBy_email_s), event_ip_s = tostring(event_ip_s), integrationIdentifier_s = tostring(integrationIdentifier_s), ip_s = tostring(ip_s), releasedBy_email_s = tostring(releasedBy_email_s), releasedFrom_tenantId_s = tostring(releasedFrom_tenantId_s), originalTenantId_s = tostring(originalTenantId_s), eventName_s = tostring(eventName_s), application_type_s = tostring(application_type_s), integrationName_s = tostring(integrationName_s), releasedBy_lastName_s = tostring(releasedBy_lastName_s), releasedBy_tenantId_s = tostring(releasedBy_tenantId_s), releasedFrom_company_s = tostring(releasedFrom_company_s), releasedFrom_name_s = tostring(releasedFrom_name_s), event_eventVersion_s = tostring(event_eventVersion_s), event_integrationIdentifier_s = tostring(event_integrationIdentifier_s), releasedBy_firstName_s = tostring(releasedBy_firstName_s), application_name_s = tostring(application_name_s), paymentInfo_s = tostring(paymentInfo_s), applicationName_s = tostring(applicationName_s), error_message_s = tostring(error_message_s), planId_s = tostring(planId_s), planName_s = tostring(planName_s), oldRole_displayName_s = tostring(oldRole_displayName_s), role_displayName_s = tostring(role_displayName_s), releasedBy_roleName_s = tostring(releasedBy_roleName_s), amount_d = toreal(amount_d), installation_installationId_g = tostring(installation_installationId_g), emails_s = tostring(emails_s), RawData = tostring(RawData), Computer = tostring(Computer), ManagementGroupName = tostring(ManagementGroupName), MG = tostring(MG), SourceSystem = tostring(SourceSystem), enabled_b = tostring(enabled_b), eventVersion_s = tostring(eventVersion_s), vpnLocation_name_s = tostring(vpnLocation_name_s), account_name_s = tostring(account_name_s), networkName_s = tostring(networkName_s), group_name_s = tostring(group_name_s), regions_s = tostring(regions_s), policy_name_s = tostring(policy_name_s), user_firstName_s = tostring(user_firstName_s), user_lastName_s = tostring(user_lastName_s), account_tenantId_s = tostring(account_tenantId_s), user_email_s = tostring(user_email_s), newPlan_name_s = tostring(newPlan_name_s), newPlan_planWeight_d = tostring(newPlan_planWeight_d), oldPlan_name_s = tostring(oldPlan_name_s), oldPlan_planWeight_d = toreal(oldPlan_planWeight_d), installation_installationId_s = tostring(installation_installationId_s), account_company_s = tostring(account_company_s), user_tenantId_s = tostring(user_tenantId_s), _ResourceId = tostring(_ResourceId)'
