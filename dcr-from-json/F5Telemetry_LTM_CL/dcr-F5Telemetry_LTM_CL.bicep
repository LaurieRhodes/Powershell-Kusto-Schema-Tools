...
// ============================================================================
// Data Collection Rule for F5Telemetry_LTM_CL
// ============================================================================
...
// Output stream: Custom-F5Telemetry_LTM_CL
...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-F5Telemetry_LTM_CL'
  location: location
  properties: {
    dataCollectionEndpointId: dataCollectionEndpointId
    streamDeclarations: {
      'Custom-F5Telemetry_LTM_CL': {
        columns: [
          {
            name: 'TimeGenerated'
            type: 'string'
