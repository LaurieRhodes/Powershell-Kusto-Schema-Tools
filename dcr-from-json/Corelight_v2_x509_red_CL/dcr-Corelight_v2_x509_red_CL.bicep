...
// ============================================================================
// Data Collection Rule for Corelight_v2_x509_red_CL
// ============================================================================
...
// Output stream: Custom-Corelight_v2_x509_red_CL
...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-Corelight_v2_x509_red_CL'
  location: location
  properties: {
    dataCollectionEndpointId: dataCollectionEndpointId
    streamDeclarations: {
      'Custom-Corelight_v2_x509_red_CL': {
        columns: [
          {
            name: 'TimeGenerated'
            type: 'string'
      ...
      logAnalytics: [
        {
          ...
          name: 'Sentinel-Corelight_v2_x509_red_CL'
        }
      ]
    }
    dataFlows: [
      {
        streams: ['Custom-Corelight_v2_x509_red_CL']
        destinations: ['Sentinel-Corelight_v2_x509_red_CL']
        ...
        outputStream: 'Custom-Corelight_v2_x509_red_CL'
      }
    ]
  }
}
