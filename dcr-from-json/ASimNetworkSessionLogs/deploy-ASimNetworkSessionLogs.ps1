# Deploy ASimNetworkSessionLogs Data Collection Rule (from JSON export)
param(
...
Write-Host "Deploying ASimNetworkSessionLogs Data Collection Rule (from JSON export)..." -ForegroundColor Cyan
