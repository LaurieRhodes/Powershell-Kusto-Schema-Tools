...
// Original columns: 9, DCR columns: 8 (Type column filtered out)
...
resource dataCollectionRule 'Microsoft.Insights/dataCollectionRules@2022-06-01' = {
  name: 'dcr-${workspaceName}-BitsightIndustrial_statistics_CL'
  location: location
  properties: {
    dataCollectionEndpointId: dataCollectionEndpointId
    streamDeclarations: {
      'Custom-BitsightIndustrial_statistics_CL': {
        columns: [
          {
            name: 'TimeGenerated'
            type: 'string'
      ...
      logAnalytics: [
        {
          ...
          name: 'Sentinel-BitsightIndustrial_statistics_CL'
        }
      ]
    }
    dataFlows: [
      {
        streams: ['Custom-BitsightIndustrial_statistics_CL']
        destinations: ['Sentinel-BitsightIndustrial_statistics_CL']
        ...
        outputStream: 'Custom-BitsightIndustrial_statistics_CL'
      }
    ]
  }
}
