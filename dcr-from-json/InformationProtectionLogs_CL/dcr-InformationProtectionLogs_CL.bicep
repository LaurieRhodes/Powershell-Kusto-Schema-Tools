    ...
    dataFlows: [
      {
        ...
        transformKql: 'source | project TimeGenerated = todatetime(TimeGenerated), TenantId = toguid(TenantId), ParentLabelName_s = tostring(ParentLabelName_s), LabelName_s = tostring(LabelName_s), AadTenantId_g = tostring(AadTenantId_g), DeviceId_g = tostring(DeviceId_g), ActionSource_s = tostring(ActionSource_s), MachineId_s = tostring(MachineId_s), DeviceRisk_s = tostring(DeviceRisk_s), InformationTypesAbove95_s = tostring(InformationTypesAbove95_s), InformationTypesAbove85_s = tostring(InformationTypesAbove85_s), InformationTypesAbove75_s = tostring(InformationTypesAbove75_s), InformationTypesAbove65_s = tostring(InformationTypesAbove65_s), InformationTypesAbove55_s = tostring(InformationTypesAbove55_s), DiscoveredInformationTypes_s = tostring(DiscoveredInformationTypes_s), InformationTypes_s = tostring(InformationTypes_s), DeviceId_s = tostring(DeviceId_s), ProcessVersion_s = tostring(ProcessVersion_s), ProtectionTime_t = todatetime(ProtectionTime_t), UserId_s = tostring(UserId_s), ContentId_g = tostring(ContentId_g), MachineName_s = tostring(MachineName_s), Workload_s = tostring(Workload_s), ActionId_g = tostring(ActionId_g), LogId_g = tostring(LogId_g), ProductVersion_s = tostring(ProductVersion_s), IsProtectionChanged_b = tobool(IsProtectionChanged_b), IsLabelChanged_b = tobool(IsLabelChanged_b), DataState_s = tostring(DataState_s), ApplicationId_g = tostring(ApplicationId_g), Location_s = tostring(Location_s), Activity_s = tostring(Activity_s), Platform_s = tostring(Platform_s), ProtectedBeforeAction_b = tobool(ProtectedBeforeAction_b), Protected_b = tobool(Protected_b), LabelId_g = tostring(LabelId_g), ObjectId_s = tostring(ObjectId_s), Operation_s = tostring(Operation_s), ApplicationName_s = tostring(ApplicationName_s), ProcessName_s = tostring(ProcessName_s), Version_s = tostring(Version_s), IPv4_s = tostring(IPv4_s), ProtectionOwner_s = tostring(ProtectionOwner_s), TemplateId_g = tostring(TemplateId_g), AadTenantId_g_g = tostring(AadTenantId_g_g), ProcessVersion_s_s = tostring(ProcessVersion_s_s), ProtectionTime_t_UTC__s = tostring(ProtectionTime_t_UTC__s), ContentId_g_g = tostring(ContentId_g_g), ProtectionOwner_s_s = tostring(ProtectionOwner_s_s), ProtectionType_s_s = tostring(ProtectionType_s_s), TemplateId_g_g = tostring(TemplateId_g_g), TimeGenerated_UTC__s = tostring(TimeGenerated_UTC__s), TimeGenerated_s = tostring(TimeGenerated_s), Protected_s = tostring(Protected_s), ProtectionTime_s = tostring(ProtectionTime_s), PK_LA___Content_Types__xml_MN_0_H_nY_t_Q_Ic_g_b_2p_J_6_oE_V_P_t_3_vX_I_u_p_e_nd_z_Q_Q_K_oH_X_U_s = tostring(PK_LA___Content_Types__xml_MN_0_H_nY_t_Q_Ic_g_b_2p_J_6_oE_V_P_t_3_vX_I_u_p_e_nd_z_Q_Q_K_oH_X_U_s), RawData = tostring(RawData), Computer = tostring(Computer), ManagementGroupName = tostring(ManagementGroupName), MG = tostring(MG), SourceSystem = tostring(SourceSystem), UserId_s_s = tostring(UserId_s_s), ProtectionType_s = tostring(ProtectionType_s), Version_s_s = tostring(Version_s_s), ProcessName_s_s = tostring(ProcessName_s_s), ActionIdBefore_g = tostring(ActionIdBefore_g), LabelNameBefore_s = tostring(LabelNameBefore_s), SensitivityChange_s = tostring(SensitivityChange_s), LabelIdBeforeAction_g = tostring(LabelIdBeforeAction_g), ParentLabelNameBefore_s = tostring(ParentLabelNameBefore_s), TemplateIdBefore_g = tostring(TemplateIdBefore_g), ProtectionTypeBefore_s = tostring(ProtectionTypeBefore_s), MatchedLabelName_s = tostring(MatchedLabelName_s), MatchedLabelId_g = tostring(MatchedLabelId_g), IPv4_s_s = tostring(IPv4_s_s), LogId_g_g = tostring(LogId_g_g), DataState_s_s = tostring(DataState_s_s), Activity_s_s = tostring(Activity_s_s), Platform_s_s = tostring(Platform_s_s), Protected_b_s = tostring(Protected_b_s), Operation_s_s = tostring(Operation_s_s), ApplicationName_s_s = tostring(ApplicationName_s_s), Workload_s_s = tostring(Workload_s_s), _ResourceId = tostring(_ResourceId)'
