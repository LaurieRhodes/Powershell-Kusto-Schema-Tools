...
resource corelightv2x509redclTable 'Microsoft.OperationalInsights/workspaces/tables@2025-02-01' = {
  parent: workspace
  ...
  properties: {
    ...
    schema: {
      name: 'Corelight_v2_x509_red_CL'
      description: 'Custom table Corelight_v2_x509_red_CL - imported from JSON schema'
      displayName: 'Corelight_v2_x509_red_CL'
      columns: [
        {
          name: 'TimeGenerated'
          type: 'dateTime'
...
output tableName string = corelightv2x509redclTable.name
output tableId string = corelightv2x509redclTable.id
output provisioningState string = corelightv2x509redclTable.properties.provisioningState
