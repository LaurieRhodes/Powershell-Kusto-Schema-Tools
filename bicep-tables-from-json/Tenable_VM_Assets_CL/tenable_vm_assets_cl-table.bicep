// Bicep template for Log Analytics custom table: Tenable_VM_Assets_CL
...
resource tenablevmassetsclTable 'Microsoft.OperationalInsights/workspaces/tables@2025-02-01' = {
  parent: workspace
  ...
  properties: {
    ...
    schema: {
      name: 'Tenable_VM_Assets_CL'
      description: 'Custom table Tenable_VM_Assets_CL - imported from JSON schema'
      displayName: 'Tenable_VM_Assets_CL'
      columns: [
        {
          name: 'TimeGenerated'
          type: 'dateTime'
...
output tableName string = tenablevmassetsclTable.name
output tableId string = tenablevmassetsclTable.id
output provisioningState string = tenablevmassetsclTable.properties.provisioningState
